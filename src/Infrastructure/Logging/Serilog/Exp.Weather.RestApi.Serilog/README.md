# Exp.Weather.RestApi.Serilog

## Maturity level

**Level 1 — Focused Pattern Example.** The implementation keeps its demonstrated mechanism visible with minimal ceremony. See the [catalog](../../../../../docs/catalog.md) for repository-wide status and sequence.
